...
async function getAllEvents() {
  let walletAddress = "0xBcE195d127cE562D435d624fF9338a999eAE2a49".toLowerCase();
  let contractAddress = "0xB2cEB39D5f45404Fff75FD9FCFD6875e07d3EBEC".toLowerCase();
...
// let getEvent2=  contract.events.allEvents([{
//   filter: [{ to: walletAddress } || { from: walletAddress }],
//   fromBlock: 0,
//   toBlock: endBlockNumber,
// }])

// console.log("getEvent2",getEvent2);

// const  receipt =await contract.methods.emitEvent('Transfer').send({
//   from : walletAddress
// });


console.log("getEvent",getEvent)
// console.log("RECEIPT_METHOD1",receipt);
